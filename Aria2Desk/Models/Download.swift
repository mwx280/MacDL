...
struct Download: Identifiable, Codable {
    ...
    init(id: UUID = UUID(), gid: String? = nil, filename: String, url: String, totalSize: Int64 = 0, downloadedSize: Int64 = 0, downloadSpeed: Int64 = 0, uploadSpeed: Int64 = 0, status: DownloadStatus = .waiting, addedAt: Date = Date(), savePath: String? = nil, connections: Int? = nil, downloadLimit: Int? = nil, uploadLimit: Int? = nil, errorMessage: String? = nil) {
        self.id = id
        self.gid = gid
