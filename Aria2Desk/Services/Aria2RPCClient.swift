...
final class Aria2RPCClient {
    ...
    private static func errorDescription(code: Int, message: String?) -> String {
        ...
        case 1:  return loc("Download failed")
        case 2:  return loc("Timeout")
        case 3:  return loc("Not Found")
        case 4:  return loc("Too many failures")
        case 5:  return loc("Download too slow")
        case 6:  return loc("Connection failed")
        case 7:  return loc("Interrupted")
        case 8:  return loc("Resume not supported")
        case 9:  return loc("Disk full")
        case 10: return loc("File corrupted")
        case 11: return loc("Already downloading")
        case 12: return loc("Duplicate torrent")
        case 13: return loc("File exists")
        case 14: return loc("Rename failed")
        case 15: return loc("Cannot read file")
        case 16: return loc("Cannot write file")
        case 17: return loc("Disk error")
        case 18: return loc("Cannot create folder")
        case 19: return loc("DNS failed")
        case 20: return loc("Invalid metalink")
        case 21: return loc("FTP error")
        case 22: return loc("Server error")
        case 23: return loc("Too many redirects")
        case 24: return loc("Authorization failed")
        case 25: return loc("Invalid torrent")
        case 26: return loc("Corrupted torrent")
        case 27: return loc("Invalid magnet link")
        case 28: return loc("Invalid option")
        case 29: return loc("Server busy")
        case 30: return loc("RPC error")
        case 31: return loc("Download failed")
        case 32: return loc("Checksum error")
        default: return loc("Download failed")
        }
    }
}
