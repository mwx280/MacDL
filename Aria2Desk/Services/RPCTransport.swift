...
final class RPCTransport: RPCTransportProtocol {
    ...
    func pause(gid: String) async -> String? {
        await call(method: "aria2.pause", params: [gid])
    }

    func pauseAll() async -> String? {
        await call(method: "aria2.pauseAll")
    }

    func unpause(gid: String) async -> String? {
        await call(method: "aria2.unpause", params: [gid])
    }

    func unpauseAll() async -> String? {
        await call(method: "aria2.unpauseAll")
    }

    func remove(gid: String) async -> String? {
        await call(method: "aria2.remove", params: [gid])
    }

    func forceRemove(gid: String) async -> String? {
    ...
    func changeOption(gid: String, options: [String: Any]) async -> String? {
